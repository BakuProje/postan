    ...
    <div class="bg-white rounded-2xl border border-neutral-200/60 p-8">
        <form method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex flex-col items-center justify-center pb-6 border-b border-neutral-100">
                <span class="text-[10px] font-bold text-neutral-400 mb-3">Foto Profil</span>
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input id="name" name="name" type="text" value="{{ old('name', $user->name) }}" required placeholder="Nama lengkap Anda" class="block w-full rounded-xl border border-neutral-200 bg-neutral-50/30 pl-10 pr-4 py-3 text-xs outline-none transition duration-200 placeholder:text-neutral-400/80 focus:border-sky-500 focus:bg-white focus:ring-4 focus:ring-sky-100/50 @error('name') border-rose-500 @enderror">
                    </div>
            ...
            <div class="pt-6 border-t border-neutral-100 flex items-center justify-end gap-3.5">
                <button type="submit" class="rounded-xl bg-sky-500 px-6 py-3 text-xs font-bold text-white transition hover:bg-sky-600 active:scale-98 cursor-pointer">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</div>
