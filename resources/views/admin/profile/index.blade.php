...
@section('konten')
    <div class="max-w-2xl mx-auto relative px-4 sm:px-0 py-4">
        <div
        ...
        <div
            ...
            <form method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data"
                ...
                <div class="flex flex-col items-center justify-center pb-8 border-b border-neutral-100/60">
                    <span class="text-[10px] font-bold text-neutral-400 tracking-wider uppercase mb-4">Foto Profil</span>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    @if ($user->profile_picture)
                                        <img id="avatar-preview" src="{{ asset($user->profile_picture) }}" alt="Preview"
                                            class="h-full w-full object-cover">
                                        <svg id="avatar-placeholder"
                                            class="hidden h-10 w-10 text-neutral-300 transition group-hover:text-sky-500"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="toggle-password"
                            ...
                            <svg id="eye-show" class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
