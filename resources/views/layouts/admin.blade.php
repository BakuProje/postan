    ...
    <aside id="desktop-sidebar" class="hidden lg:flex lg:flex-col lg:w-64 bg-white/80 backdrop-blur-lg border-r border-neutral-200/50 shrink-0 sticky top-0 h-screen p-6 justify-between z-20 relative overflow-hidden transition-all duration-300">
        ...
        <div class="space-y-8 relative z-10">
            ...
            <nav class="space-y-1.5">
                ...
                <a href="{{ route('admin.outlet') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-xs font-bold transition-all duration-150 sidebar-nav-link {{ request()->routeIs('admin.outlet') ? 'bg-sky-50 text-sky-600' : 'text-neutral-500 hover:bg-neutral-50/50 hover:text-neutral-900' }}">
                    <svg class="size-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75 3.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h2.25A2.25 2.25 0 0 0 22.5 18.75V8.184c0-.528-.186-1.04-.526-1.442l-5.184-6.13A2.25 2.25 0 0 0 15.084 0H4.916c-.722 0-1.4.345-1.826.924l-2.072 2.812A2.247 2.247 0 0 0 .5 5.184v13.566A2.25 2.25 0 0 0 2.75 21H18Z" />
                    </svg>
                    <span class="sidebar-text">Outlet</span>
                </a>
