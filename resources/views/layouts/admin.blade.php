    ...
    <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-white border-r border-neutral-200/60 shrink-0 sticky top-0 h-screen p-6 justify-between z-20">
        <div class="space-y-8">
            ...
            <nav class="space-y-1.5">
                ...
                <a href="{{ route('admin.categories') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-xs font-bold transition-all duration-150 {{ request()->routeIs('admin.categories') ? 'bg-sky-50 text-sky-600' : 'text-neutral-500 hover:bg-neutral-50/50 hover:text-neutral-900' }}">
                    <svg class="size-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
